    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-6">							
                <div class="small-box card">
                    <div class="inner">
                        <h3>RM {{ number_format($totalSalesThisMonth,2) }}</h3>
                        <p>Total Sales This Month ({{ $thisMonthName }})</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-person-add"></i>
                    </div>
            ...
            <div class="col-lg-4 col-6">							
                <div class="small-box card">
                    <div class="inner">
                        <h3>RM {{ number_format($totalSalesLastMonth,2) }}</h3>
                        <p>Total Sales Last Month ({{ $lastMonthName }})</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-person-add"></i>
                    </div>
